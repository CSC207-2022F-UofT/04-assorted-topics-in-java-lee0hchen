...
class DrivableTrader extends Trader<Drivable>{
    ...
    /**
     * Given money, construct a DrivableTrader that inventory and wishlist are set to empty
     *
     * @param money This Trader's money
     */
